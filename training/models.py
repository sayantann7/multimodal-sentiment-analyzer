...
class MultimodalSentimentModel(nn.Module):
    def __init__(self):
        ...
        # Classifiers for emotion & sentiment
...
class MultimodalTrainer:
    ...
    def log_metrics(self, losses, metrics=None, phase="val"):
        if phase=="train":
    ...
    def train_epoc(self):
        ...
        for batch in self.train_loader:
            ...
            running_loss["emotion"] += emotion_loss
            running_loss["sentiment"] += sentiment_loss
